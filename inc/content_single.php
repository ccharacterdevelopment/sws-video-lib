...
switch (get_post_type()) {
	case('videos'): $myArr=sws_show_single(get_fields());
		$display_title=$myArr['title']; break;
	case('readings'): $myArr=sws_off_info();
		$display_title=$myArr['topic'];
		break;
	case('tribe_events'): $display_title="Event"; break;
	default:  break;
}	
...
switch (get_post_type()) {
	...
	default:  break;
      ...
      <?php if (get_post_type()=='readings') { get_sidebar('offertory'); } else { get_sidebar("videos"); } ?>
    </div> <!-- /.flex-container -->
